...
import project.volunteer.domain.scheduleParticipation.api.ScheduleParticipantController;
...
@RestControllerAdvice(basePackageClasses = ScheduleParticipantController.class)
