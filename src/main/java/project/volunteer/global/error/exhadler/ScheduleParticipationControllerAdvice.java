...
import project.volunteer.domain.scheduleParticipation.api.ScheduleParticipationController;
...
@RestControllerAdvice(basePackageClasses = ScheduleParticipationController.class)
public class ScheduleParticipationControllerAdvice {
