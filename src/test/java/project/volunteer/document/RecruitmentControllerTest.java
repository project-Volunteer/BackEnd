                ...
                .andDo(
                        restDocs.document(
                                ...
                                requestParameters(
                                        ...
                                        parameterWithName("maxParticipationNum").attributes(key("constraints").value("1이상 9999이하")).description("봉사 모집 인원"),
                                        parameterWithName("volunteeringType").description("Code VolunteeringType 참고바람"),
                                        parameterWithName("startDate").attributes(getDateFormat()).description("봉사 모집 시작 날짜"),
                                        parameterWithName("endDate").attributes(getDateFormat()).description("봉사 모집 종료 날짜"),
                                        ...
                                        parameterWithName("period").optional().attributes(key("constraints").value("비정기일 경우 NONE")).description("Code Period 참고바람."),
                                        parameterWithName("week").optional().attributes(key("constraints").value("비정기 혹은 Period가 매주일 경우 NONE")).description("Code Week 참고바람."),
                                        parameterWithName("dayOfWeeks").optional().attributes(key("constraints").value("비정기일 경우 빈 배열")).description("Code Day 참고바람, 다중 값 허용(배열)"),
