...
//        Timetable recruitmentTimetable = new Timetable(LocalDate.now(), LocalDate.now(), HourFormat.AM, LocalTime.now(), 10);
//        Coordinate coordinate = Coordinate.createCoordinate(3.2F, 3.2F);
//
//        //봉사 모집글 저장
//        Recruitment saveRecruitment = Recruitment.create("test", "test", VolunteeringCategory.EDUCATION, VolunteeringType.REG,
...
//
//        //봉사 반복 주기 저장
//        RepeatPeriod repeatPeriod = RepeatPeriod.of(Period.MONTH, Week.FIRST, Day.MON);
//        repeatPeriod.assignRecruitment(saveRecruitment);
