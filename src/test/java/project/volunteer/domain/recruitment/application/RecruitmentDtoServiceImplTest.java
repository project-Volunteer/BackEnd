...
//        final Timetable timetable = new Timetable(LocalDate.now(), LocalDate.now().plusMonths(3), HourFormat.AM, LocalTime.now(), 3);
//        final  Boolean isPublished = true;
//
//        Recruitment createRecruitment = Recruitment.create(title, content, category, volunteeringType, volunteerType, volunteerNum, isIssued, organizationName,
...
//
//        //반복 주기 저장(정기 모집글)
//        RepeatPeriod period = RepeatPeriod.of(Period.MONTH, Week.FIRST, Day.MON);
//        period.assignRecruitment(save);
...
//                () -> assertThat(details.getVolunteerNum()).isEqualTo(saveRecruitment.getMaxParticipationNum()),
