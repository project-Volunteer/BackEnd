...
//
//        //정기 모집글 등록
//        Recruitment createRecruitment = Recruitment.create("title", "content", VolunteeringCategory.CULTURAL_EVENT, VolunteeringType.REG,
...
//                new Timetable(LocalDate.now(), LocalDate.now(), HourFormat.AM, LocalTime.now(), 3), true);
//        createRecruitment.setWriter(writer);
//        saveRecruitment = recruitmentRepository.save(createRecruitment);
//
//        //반복 주기 저장
//        RepeatPeriod period1 = RepeatPeriod.of(Period.MONTH, Week.FIRST, Day.MON);
//        period1.assignRecruitment(saveRecruitment);
//        RepeatPeriod period2 = RepeatPeriod.of(Period.MONTH, Week.FIRST, Day.TUES);
//        period2.assignRecruitment(saveRecruitment);
