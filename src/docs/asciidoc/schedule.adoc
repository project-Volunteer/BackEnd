...
==== 요청
*HTTP Request*
include::{snippets}/schedule-controller-test/calendar-list-schedule/http-request.adoc[]

*Request Header*
include::{snippets}/schedule-controller-test/calendar-list-schedule/request-headers.adoc[]

*Request Path*
include::{snippets}/schedule-controller-test/calendar-list-schedule/path-parameters.adoc[]

*Request Parameters*
include::{snippets}/schedule-controller-test/calendar-list-schedule/request-parameters.adoc[]

==== 응답
*HTTP Response*
include::{snippets}/schedule-controller-test/calendar-list-schedule/http-response.adoc[]

*Response Body*
include::{snippets}/schedule-controller-test/calendar-list-schedule/response-fields.adoc[]
